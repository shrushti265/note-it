...
const FilterDrawer = ({handleChangeShowFilterModal}) => {
    ...
    const { labels, filterByLabel, sortBy, notesDispatch } = useNotes();
    ...
    const handleSortByChanges = ({ target: {value} }) => {
        notesDispatch({ 
            action: {
                type: "SORT_BY",
            ...
            <div className="filter-sort-drawer py-0-25">
                ...
                <div className="filter-sort-options py-0-75 flex-col flex-align-start flex-justify-center">
                    <div className="sort-options">
                        ...
                        <select name="sort-by" id="sort-by" className="dropdown sorting-dropdown px-0-5 py-0-25 mt-0-25 text-sm" onChange={handleSortByChanges} value={sortBy}>
                            <options value="" name="sort-by" defaultValue disabled>
                                --Chose Option--
                            </options>
